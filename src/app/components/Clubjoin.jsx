    ...
    <div className="text-bono-10 py-12 justify-center px-6 md:px-24 lg:px-36">
      ...
      <form className="max-w-lg mx-auto" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="relative mb-4 mt-3">
          <input type="text" className="w-full lg:w-12/12 p-8 bg-knap-10 border border-gray-600 rounded-xl placeholder-transparent focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Navn*" {...register("name", { required: true })} onFocus={() => setNameFocused(true)} onBlur={() => setNameFocused(false)} required />
        ...
        <div className="mb-4 flex items-start">
          <input type="checkbox" className="mt-1 mr-2" aria-label="checkbox" {...register("agreement", { required: true })} required />
        ...
        {formError && <span className="text-red-500 mb-4">{formError}</span>}
