            ...
            {loading
              ...
              : row.map((band, index) => (
                  <Link key={band.slug} href={`/bands/${band.slug}`} passHref>
                    <div className={`group text-xxs relative text-center cursor-pointer ${index % 2 !== 0 ? "mt-[5em] hover:-rotate-9 transition-all duration-200 ease-in-out transform hover:scale-105" : "hover:-rotate-8 transition-all duration-300 ease-in-out transform hover:scale-105"}`}>
